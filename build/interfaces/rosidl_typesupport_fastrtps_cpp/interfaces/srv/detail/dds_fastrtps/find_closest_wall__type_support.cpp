...
#include "interfaces/srv/detail/find_closest_wall__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::FindClosestWall_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::FindClosestWall_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::FindClosestWall_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::FindClosestWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::FindClosestWall_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, FindClosestWall_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::FindClosestWall_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: distance
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::FindClosestWall_Response & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::FindClosestWall_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::FindClosestWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::FindClosestWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, FindClosestWall_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall_Response__handle;
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, FindClosestWall)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_FindClosestWall__handle;
}
