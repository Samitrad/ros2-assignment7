...
class Metaclass_FindClosestWall(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.srv.FindClosestWall')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from interfaces.srv import _find_closest_wall
...
class FindClosestWall(metaclass=Metaclass_FindClosestWall):
    from interfaces.srv._find_closest_wall import FindClosestWall_Request as Request
    from interfaces.srv._find_closest_wall import FindClosestWall_Response as Response
