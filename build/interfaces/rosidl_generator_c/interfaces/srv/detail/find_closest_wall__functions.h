...
#ifndef INTERFACES__SRV__DETAIL__FIND_CLOSEST_WALL__FUNCTIONS_H_
#define INTERFACES__SRV__DETAIL__FIND_CLOSEST_WALL__FUNCTIONS_H_
 ...
 * calls
 * interfaces__srv__FindClosestWall_Request__init().
...
/**
 * It calls
 * interfaces__srv__FindClosestWall_Request__fini()
 ...
 * interfaces__srv__FindClosestWall_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * interfaces__srv__FindClosestWall_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces__srv__FindClosestWall_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It calls
 * interfaces__srv__FindClosestWall_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It allocates the memory for the array and calls
 * interfaces__srv__FindClosestWall_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It calls
 * interfaces__srv__FindClosestWall_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACES__SRV__DETAIL__FIND_CLOSEST_WALL__FUNCTIONS_H_
