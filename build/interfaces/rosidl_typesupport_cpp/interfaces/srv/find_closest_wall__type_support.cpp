...
static const _FindClosestWall_Request_type_support_symbol_names_t _FindClosestWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, FindClosestWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, FindClosestWall_Request)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::FindClosestWall_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, FindClosestWall_Request)() {
  return get_message_type_support_handle<interfaces::srv::FindClosestWall_Request>();
}
...
static const _FindClosestWall_Response_type_support_symbol_names_t _FindClosestWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, FindClosestWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, FindClosestWall_Response)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::FindClosestWall_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, FindClosestWall_Response)() {
  return get_message_type_support_handle<interfaces::srv::FindClosestWall_Response>();
}
...
static const _FindClosestWall_type_support_symbol_names_t _FindClosestWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, FindClosestWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, FindClosestWall)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::FindClosestWall_service_type_support_handle;
}
